...
# the defenition of the Dehaze-P2PNet model
class Dehaze_P2PNet(nn.Module):
...
# create the Dehaze-P2PNet model
def build(args, training):
    print("build Dehaze-P2PNet!")
    print("build L2 Loss!")
    # treats persons as a single class
    num_classes = 1

    backbone = build_backbone(args)
    model = Dehaze_P2PNet(backbone, args.row, args.line)
    if not training:
        return model
